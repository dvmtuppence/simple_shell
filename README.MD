...
Installation
Clone this rollowing flags: -Wall -Wextra -Werror -pedantic -sepository into your working directory. For best results, files should be compiled with GCC and the ftd=gnu89
...
Credits
All code written by Ella and Alexxy.
